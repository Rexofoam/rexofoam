              ...
              <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="mt-4 text-sm text-gray-600">
                    <p>
                      <strong>Remaining AP:</strong>{" "}
                      {characterData.stat.remain_ap}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <div className="mb-4">
                      <p>
                        ...
                        {characterData.hyperStat.use_preset_no}
                      </p>
                      <p>
                        <strong>Available Points:</strong>{" "}
                        {characterData.hyperStat.use_available_hyper_stat}
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {[
                        {
                          name: "Preset 1",
                          data: characterData.hyperStat.hyper_stat_preset_1,
                        },
                        {
                          name: "Preset 2",
                          data: characterData.hyperStat.hyper_stat_preset_2,
                        },
                        {
                          name: "Preset 3",
                          data: characterData.hyperStat.hyper_stat_preset_3,
                        },
                      ].map((preset, index) => (
                        <div
                          key={index}
                        ...
                        >
                          ...
                          {preset.data && (
                            <div className="space-y-1 text-sm">
                              <p>
                                <strong>Type:</strong> {preset.data.stat_type}
                              </p>
                              <p>
                                <strong>Points:</strong>{" "}
                                {preset.data.stat_point}
                              </p>
                              <p>
                                <strong>Level:</strong> {preset.data.stat_level}
                              </p>
                              <p>
                                <strong>Increase:</strong>{" "}
                                {preset.data.stat_increase}
                              </p>
                            </div>
                          )}
                        </div>
              ...
              {characterData.ability && (
                <div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <div className="mb-4">
                      <p>
                        <strong>Ability Grade:</strong>{" "}
                        {characterData.ability.ability_grade}
                      </p>
                      <p>
                        <strong>Remaining Fame:</strong>{" "}
                        {characterData.ability.remain_fame}
                      </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {characterData.ability.ability_info?.map(
                        (ability, index) => (
                          <div
                            key={index}
                          ...
                          >
                            <div className="text-sm">
                              <p>
                                <strong>Grade:</strong> {ability.ability_grade}
                              </p>
                              <p>
                                <strong>Value:</strong> {ability.ability_value}
                              </p>
                            </div>
                          </div>
                        )
